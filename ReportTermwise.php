...
<form id="form1" method="post" action="QueryResults_Termwise.php">
  <table width="923" height="138" border="0">
    <tr>
      <td height="32" colspan="6" class="heading">Students Details with Coursedetails (Termwise)</td>
    </tr>
    <tr>
  ...
  <table width="648" border="0">
    ...
    <tr>
      <td class="fieldheading">Breakdown of all Students who began their course before</td>
