...
else if ($term!="" )
{
	...
	$res = mysql_query($sql) or die($sql."<br/><br/>".mysql_error());
		...
		echo '<th class="fieldheading">Mitigation</th>';
		echo '<th class="fieldheading">Advices</th>';
		...
		while ($row = mysql_fetch_array($res))
		{
			...
			echo '<td width=200 "displaydata">' .$row['Mitigation']. '</td>';
			echo '<td width=500 "displaydata">'.$row['Advices'].'</td>';
