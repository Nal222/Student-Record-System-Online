...
$sql="Select CourseName from coursenames where CourseNameID= '$coursename'";
 ...
 $result = mysql_query ($sql);
	...
	$sql="Select StudentID,FirstName,LastName,CourseName,MonthName(Term) as TermMon, Year(Term)as TermYr,Units  from view_studentunitdetails where CourseName Like '%$coursename%' ";
}
# Selected FirstName
else if ($firstname!="" )
{
...
else if ($term!="" )
{
    ...
    $term = $row['Term'];
	echo $term;
	$sql="Select * from view_studentunitdetails where Term <'$term'";
}
